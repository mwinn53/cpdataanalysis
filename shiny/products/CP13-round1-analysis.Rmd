...
Additionally, this year was the first time the Cisco Networking Challenge was part of the first round.
...
```{r statesummary}
  renderTable({
    vars <- c("StatePlace", "TeamNumber", "TeamName", "OverallPlace", "TotalScore", "Difference", "OffLead")
